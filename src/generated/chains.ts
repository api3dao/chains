...
export const CHAINS: Chain[] = [
  ...
  },
  {
    ...
    providers: [
      ...
      { alias: 'publicnode', rpcUrl: 'https://b2-mainnet.alt.technology' },
    ],
    symbol: 'BTC',
    testnet: false,
  },
  ...
  },
  {
    ...
    explorer: {
      api: {
        key: { required: false },
        url: 'https://www.oklink.com/api/v5/explorer/contract/verify-source-code-plugin/amoy_testnet',
      },
      browserUrl: 'https://www.oklink.com/amoy',
    },
    id: '80002',
    name: 'Polygon Amoy testnet',
    providers: [{ alias: 'default', rpcUrl: 'https://rpc-amoy.polygon.technology' }],
    symbol: 'MATIC',
    testnet: false,
  },
  {
  ...
  },
  {
    ...
    providers: [
      ...
      { alias: 'publicnode', rpcUrl: 'https://evm-rpc.arctic-1.seinetwork.io' },
    ],
    symbol: 'SEI',
    testnet: true,
  },
